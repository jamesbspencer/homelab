...
| **PostgreSQL / pgvector** | Relational & Vector Database | `:5432` (Internal `db` network) | [Postgres Guide](file:///data/homelab/docs/postgres.md) |
...
3. **`db`**: Isolated database network shared between PostgreSQL (`db`) and Open WebUI.
